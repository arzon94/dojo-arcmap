define([
	...
	return declare("dijit._editor.plugins.AlwaysShowToolbar", _Plugin, {
		...
		setEditor: function(e){
			...
			if(!e.iframe){
				 0 && console.log('Port AlwaysShowToolbar plugin to work with Editor without iframe');
				return;
			}
		...
		_updateHeight: function(){
			...
			if(height == 0){
				 0 && console.debug("Can not figure out the height of the editing area!");
