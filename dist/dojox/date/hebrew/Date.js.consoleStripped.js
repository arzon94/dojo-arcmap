...
var HDate = declare("dojox.date.hebrew.Date", null, {
	...
	//	|	 0 && console.log(date.getFullYear()+'\'+date.getMonth()+'\'+date.getDate());
	...
	*/
	...
	getMonth: function(){
		...
		//	|	 0 && console.log(date1.getMonth()+1);
		//	|	>> 7
	...
	getFullYear: function(){
		...
		// example:
		//	|	var date1 = new dojox.date.hebrew.Date(5769, 6, 1);
		//	|	 0 && console.log(date1.getFullYear());
		//	|	>> 5769
		return this._year;
	},
