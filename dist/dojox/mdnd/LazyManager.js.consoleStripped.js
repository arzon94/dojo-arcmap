define([
		...
		null,
	{
		...
		constructor: function(){
			// 0 && console.log("dojox.mdnd.LazyManager ::: constructor");
			this._registry = {};
		...
		getItem: function(/*DOMNode*/draggedNode){
			// 0 && console.log("dojox.mdnd.LazyManager ::: getItem");
		...
		startDrag: function(/*Event*/e, /*DOMNode?*/draggedNode){
			...
			// 0 && console.log("dojox.mdnd.LazyManager ::: startDrag");
		...
		cancelDrag: function(){
			...
			// 0 && console.log("dojox.mdnd.LazyManager ::: cancelDrag");
			var m = this.manager;
			m.target = null;
			m.onMouseUp();
		},
		...
		destroy: function(){
			// 0 && console.log("dojox.mdnd.LazyManager ::: destroy");
