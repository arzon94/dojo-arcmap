define(["dojo/_base/kernel",
		...
		null,
	{
		...
		constructor: function(){
			// 0 && console.log("dojox.mdnd.DropIndicator ::: constructor");
		...
		place: function(/*Node*/area, /*Node*/nodeRef, /*Object*/size){
			...
			// 0 && console.log("dojox.mdnd.DropIndicator ::: place");
			if(size){
		...
		remove: function(){
			...
			// 0 && console.log("dojox.mdnd.DropIndicator ::: remove");
			if(this.node){
				//FIX : IE6 problem
		...
		destroy: function(){
			...
			// 0 && console.log("dojox.mdnd.DropIndicator ::: destroy");
			if(this.node){
				if(this.node.parentNode){
					this.node.parentNode.removeChild(this.node);
				}
