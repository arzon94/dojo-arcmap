define([
	...
	var ddm = declare("dojox.mdnd.dropMode.DefaultDropMode", null, {
		...
		addArea: function(/*Array*/areas, /*Object*/object){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: addArea");
		...
		updateAreas: function(/*Array*/areaList){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: initAreas");
		...
		_updateArea : function(/*Object*/area){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode  ::: _updateArea");
		...
		initItems: function(/*Object*/area){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: initItems");
		...
		refreshItems: function(/*Object*/area, /*Integer*/indexItem, /*Object*/size, /*Boolean*/added){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: refreshItems");
			if (indexItem == -1) {
				return;
		...
		getDragPoint: function(/*Object*/coords, /*Object*/size, /*Object*/mousePosition){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: getDragPoint");
			var y = coords.y;
			if (this._oldYPoint){
		...
		getTargetArea: function(/*Array*/areaList, /*Object*/ coords, /*integer*/currentIndexArea ){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: getTargetArea");
			var index = 0;
			var x = coords.x;
		...
		getDropIndex: function(/*Object*/ targetArea, /*Object*/ coords){
			...
			// 0 && console.log("dojox.mdnd.dropMode.DefaultDropMode ::: getDropIndex");
