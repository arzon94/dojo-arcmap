define(["dojo/_base/kernel",
		...
		null,
	{
		...
		constructor: function(){
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: constructor");
			this._dragHandler = [
		...
		addArea: function(/*Array*/areas, /*Object*/object){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: addArea");
		...
		updateAreas: function(/*Array*/areaList){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: updateAreas");
		...
		initItems: function(/*Object*/area){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: initItems");
		...
		refreshItems: function(/*Object*/area, /*Integer*/indexItem, /*Object*/size, /*Boolean*/added){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: refreshItems", area, indexItem, size, added);
			if(indexItem == -1){
				return;
			}
		...
		getDragPoint: function(/*Object*/coords, /*Object*/size, /*Object*/mousePosition){
			...
			// 0 && console.log("dojox.mdnd.OverDropMode ::: getDragPoint");
			return {			// Object
				'x': mousePosition.x,
				'y': mousePosition.y
				}
		...
		getTargetArea: function(/*Array*/areaList, /*Object*/ coords, /*integer*/currentIndexArea ){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: getTargetArea");
			var index = 0;
			var x = coords.x;
			var y = coords.y;
		...
		_checkInterval: function(/*Array*/areaList, /*Integer*/index, /*Coord*/x, /*Coord*/y){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: _checkInterval");
		...
		getDropIndex: function(/*Object*/ targetArea, /*Object*/ coords){
			...
			// 0 && console.log("dojox.mdnd.dropMode.OverDropMode ::: getDropIndex");
