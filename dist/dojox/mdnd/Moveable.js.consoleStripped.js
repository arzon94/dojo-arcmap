define([
		...
		null,
	{
		...
		constructor: function(/*Object*/params, /*DOMNode*/node){
			...
			// 0 && console.log("dojox.mdnd.Moveable ::: constructor");
		...
		isFormElement: function(/*DOMEvent*/ e){
			...
			// 0 && console.log("dojox.mdnd.Moveable ::: isFormElement");
			var t = e.target;
		...
		onMouseDown: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.Moveable ::: onMouseDown");
		...
		onFirstMove: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.Moveable ::: onFirstMove");
			event.stop(e);
		...
		initOffsetDrag: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.Moveable ::: initOffsetDrag");
		...
		onMove: function(/*DOMEvent*/e){
			...
			// 0 && console.log("dojox.mdnd.Moveable ::: onMove");
			event.stop(e);
		...
		destroy: function(){
			...
			//  0 && console.log("dojox.mdnd.Moveable ::: destroy");
