define(["dojo/_base/kernel",
		...
		null,
	{
		...
		constructor: function(){
			// 0 && console.log("dojox.mdnd.AutoScroll ::: constructor ");
		...
		init: function(){
			// 0 && console.log("dojox.mdnd.AutoScroll ::: init ");
		...
		getViewport:function(){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: getViewport ");
		...
		setAutoScrollNode: function(/*Node*/node){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: setAutoScrollNode ");
			this._node = node;
		},
		...
		setAutoScrollMaxPage: function(){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: setAutoScrollMaxPage ");
		...
		checkAutoScroll: function(/*Event*/e){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: checkAutoScroll");
		...
		_autoScrollDown: function(){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: _autoScrollDown ");
			if(this._timer){
		...
		_autoScrollUp: function(){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: _autoScrollUp ");
			if(this._timer){
				clearTimeout(this._timer);
			}
		...
		_autoScrollRight: function(){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: _autoScrollRight ");
			if(this._timer){
				clearTimeout(this._timer);
			}
		...
		_autoScrollLeft: function(/*Event*/e){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: _autoScrollLeft ");
			if(this._timer){
				clearTimeout(this._timer);
			}
		...
		stopAutoScroll: function(){
			...
			// 0 && console.log("dojox.mdnd.AutoScroll ::: stopAutoScroll ");
			if(this._timer){
				clearTimeout(this._timer);
			}
		...
		destroy: function(){
			// 0 && console.log("dojox.mdnd.AutoScroll ::: destroy ");
