define(["dojo/_base/kernel",
		...
		Selector,
	{
		...
		constructor: function(/*DOMNode|String*/node, /*dojo.dnd.__SourceArgs?*/params){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: constructor');
		...
		onDndCancel: function(){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: onDndCancel');
			this.isDragging = false;
			this.mouseDown = false;
		...
		copyState: function(/*Boolean*/keyPressed){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: copyState');
		...
		destroy: function(){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: destroy');
		...
		markupFactory: function(/*Object*/params, /*DomNode*/node){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: markupFactory');
		...
		onMouseMove: function(/*Event*/e){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: onMouseMove');
			if(this.isDragging){
				return;
			}
		...
		onMouseDown: function(/*Event*/e){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: onMouseDown');
		...
		onMouseUp: function(/*Event*/e){
			...
			// 0 && console.log('.dnd.PureSource ::: onMouseUp');
			if(this.mouseDown){
				this.mouseDown = false;
		...
		onOverEvent: function(){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: onOverEvent');
		...
		onOutEvent: function(){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: onOutEvent');
		...
		_markDndStatus: function(/*Boolean*/copy){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: _markDndStatus');
		...
		_legalMouseDown: function(/*Event*/e){
			...
			// 0 && console.log('dojox.mdnd.PureSource ::: _legalMouseDown');
