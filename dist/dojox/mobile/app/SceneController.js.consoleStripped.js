	...
	dojo.declare("dojox.mobile.app.SceneController", dojox.mobile.View, {
		...
		_setContents: function(templateHtml){
			...
			dojox.mobile.app.loadResourcesForScene(this.sceneName, function(){
				 ...
				 0 && console.log("All resources for ",_this.sceneName," loaded");
					...
					dojo.xhrGet({
						...
						try{
							dojo.eval(text);
							 ...
							 0 && console.log("Error initializing code for scene " + _this.sceneName
		...
		_initAssistant: function(){
			...
			//		is declared.
			 ...
			 0 && console.log("Instantiating the scene assistant " + this.sceneAssistantName);
		...
		showAlertDialog: function(props){
			...
			this.assistant.domNode.appendChild(dialog.domNode);
			 ...
			 0 && console.log("Appended " , dialog.domNode, " to ", this.assistant.domNode);
			dialog.show();
		},
