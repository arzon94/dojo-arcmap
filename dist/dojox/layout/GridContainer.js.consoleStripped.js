define([
		...
		GridContainerLite,
	{
		...
		startup: function(){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: startup");
		...
		onShow: function(){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: onShow");
			this.inherited(arguments);
			this._placeGrips();
		},
		...
		resize: function(){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: resize");
			this.inherited(arguments);
			// Fix IE6 :
		...
		_createGrip: function(/*Integer*/ index){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _createGrip");
		...
		_placeGrips: function(){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _placeGrips");
		...
		_onGripDbClick: function(){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _onGripDbClick");
		...
		_resizeColumnOn: function(/*Event*/e){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _resizeColumnOn", e);
		...
		_onGripMouseUp: function(){
			...
			// 0 && console.log(dojox.layout.GridContainer ::: _onGripMouseUp");
		...
		_resizeColumnMove: function(/*Event*/e){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _resizeColumnMove");
			e.preventDefault();
		...
		_resizeColumnOff: function(/*Event*/e){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _resizeColumnOff");
			win.body().style.cursor = "default";
		...
		setColumns: function(/*Integer*/nbColumns){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: setColumns");
			var z, j;
			if(nbColumns > 0){
		...
		_addColumn: function(/*Integer*/nbColumns){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _addColumn");
			var grid = this._grid,
				dropZone,
				node,
				index,
		...
		_deleteColumn: function(/*Array*/indices){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _deleteColumn");
