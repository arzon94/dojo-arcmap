...
define([
		...
		[_LayoutWidget, _TemplatedMixin],
	{
		...
		postCreate: function(){
			// 0 && console.log("dojox.layout.GridContainerLite ::: postCreate");
			...
			//  0 && console.info("autorefresh ::: ", this.autoRefresh);
		...
		startup: function(){
			// 0 && console.log("dojox.layout.GridContainerLite ::: startup");
		...
		resizeChildAfterDrop: function(/*Node*/node, /*Object*/targetArea, /*Integer*/indexChild){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: resizeChildAfterDrop");
			if(this._disabled){
				return false;
			}
		...
		resizeChildAfterDragStart: function(/*Node*/node, /*Object*/sourceArea, /*Integer*/indexChild){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: resizeChildAfterDragStart");
			if(this._disabled){
				return false;
			}
		...
		_isShown: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: _isShown");
		...
		layout: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: layout");
			if(this.doLayout){
		...
		onShow: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: onShow");
			if(this._disabled){
				this.enableDnd();
			}
		},
		...
		onHide: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: onHide");
			if(!this._disabled){
				this.disableDnd();
			}
		},
		...
		_createCells: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: _createCells");
		...
		enableDnd: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: enableDnd");
		...
		disableDnd: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: disableDnd");
			var m = this._dragManager;
			array.forEach(this._grid, function(dropZone){
		...
		_organizeChildren: function(){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: _organizeChildren");
			...
			var numZones = this.nbZones,
				...
				i = 0;
	//		 0 && console.log('numPerZone', numPerZone, ':: mod', mod);
		...
		_organizeChildrenManually: function (){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: _organizeChildrenManually");
			var children = gcl.superclass.getChildren.call(this),
		...
		_insertChild: function(/*Widget*/child, /*Integer*/column, /*Integer?*/p){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: _insertChild", child, column, p);
		...
		removeChild: function(/*Widget*/ widget){
			// 0 && console.log("dojox.layout.GridContainerLite ::: removeChild");
			if(this._disabled){
				this.inherited(arguments);
			}
			else{
		...
		addService: function(/*Object*/child, /*Integer?*/column, /*Integer?*/p){
			// 0 && console.log("dojox.layout.GridContainerLite ::: addService");
		...
		addChild: function(/*Object*/child, /*Integer?*/column, /*Integer?*/p){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: addChild");
		...
		_updateColumnsWidth: function(/*Object*/ manager){
			...
			// 0 && console.log("dojox.layout.GridContainer ::: _updateColumnsWidth");
		...
		_selectFocus: function(/*Event*/event){
			...
			// 0 && console.log("dojox.layout.GridContainerLite ::: _selectFocus");
		...
		destroy: function(){
			// 0 && console.log("dojox.layout.GridContainerLite ::: destroy");
			var m = this._dragManager;
			array.forEach(this._grid, function(dropZone){
				m.unregister(dropZone.node);
			});
