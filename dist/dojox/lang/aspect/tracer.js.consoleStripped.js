	...
	dojo.extend(Tracer, {
		...
		afterReturning: function(retVal){
			...
			if(typeof retVal != "undefined"){
				 0 && console.log(joinPoint.targetName + "() returns:", retVal);
			}else{
				 0 && console.log(joinPoint.targetName + "() returns");
			}
		},
		afterThrowing: function(excp){
			 0 && console.log(aop.getContext().joinPoint.targetName + "() throws:", excp);
		},
