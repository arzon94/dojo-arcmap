...
if(dojo.gears.available){
	...
	(function(){
		...
		dojo.declare("dojox.storage.GearsStorageProvider", dojox.storage.Provider, {
			...
			initialize: function(){
				// 0 && console.debug("dojox.storage.GearsStorageProvider.initialize");
			...
			put: function(key, value, resultsHandler, namespace){
				...
				try{
					...
					// indicate we failed
					 0 && console.debug("dojox.storage.GearsStorageProvider.put:", e);
			...
			putMultiple: function(keys, values, resultsHandler, namespace) {
				...
				try{
					...
					// indicate we failed
					 0 && console.debug("dojox.storage.GearsStorageProvider.putMultiple:", e);
					if(resultsHandler){
			...
			_initStorage: function(){
				...
				try{
					...
					dojox.sql("CREATE UNIQUE INDEX IF NOT EXISTS namespace_key_index"
					 ...
					 0 && console.debug("dojox.storage.GearsStorageProvider._createTables:", e);
