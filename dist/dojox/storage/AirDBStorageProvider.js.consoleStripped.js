		...
		dojo.declare("dojox.storage.AirDBStorageProvider", [ dojox.storage.Provider ], {
			...
			initialize: function(){
				...
				try{
					...
					this.initialized = true;
					 ...
					 0 && console.debug("dojox.storage.AirDBStorageProvider.initialize:", e);
				}
			...
			put: function(key, value, resultsHandler, namespace){
				...
				try{
					...
					// indicate we failed
					 0 && console.debug("dojox.storage.AirDBStorageProvider.put:", e);
			...
			putMultiple: function(keys, values, resultsHandler, namespace) {
				...
				try{
					...
					// indicate we failed
					 0 && console.debug("dojox.storage.AirDBStorageProvider.putMultiple:", e);
					if(resultsHandler){
