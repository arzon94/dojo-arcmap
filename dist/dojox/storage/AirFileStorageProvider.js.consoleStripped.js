		...
		dojo.declare("dojox.storage.AirFileStorageProvider", [ dojox.storage.Provider ], {
			...
			initialize: function(){
				...
				try{
					...
					this.initialized = true;
					 ...
					 0 && console.debug("dojox.storage.AirFileStorageProvider.initialize:", e);
				}
			...
			put: function(key, value, resultsHandler, namespace){
				...
				try{
					...
					// indicate we failed
					 0 && console.debug("dojox.storage.AirFileStorageProvider.put:", e);
			...
			putMultiple: function(keys, values, resultsHandler, namespace) {
				...
				try{
					...
					// indicate we failed
					 0 && console.debug("dojox.storage.AirFileStorageProvider.putMultiple:", e);
					if(resultsHandler){
