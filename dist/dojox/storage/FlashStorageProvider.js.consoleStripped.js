...
dojo.declare("dojox.storage.FlashStorageProvider", dojox.storage.Provider, {
		...
		initialize: function(){
		  // 0 && console.debug("FlashStorageProvider.initialize");
		...
		_onStatus: function(statusResult, key, namespace){
		  // 0 && console.debug("onStatus, statusResult="+statusResult+", key="+key);
