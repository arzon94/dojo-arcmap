...
var Rearrange = declare("dojox.grid.enhanced.plugins.Rearrange", _Plugin, {
	...
	moveColumns: function(colsToMove, targetPos){
		...
		// 0 && console.log("mapping:", mapping, ", colsToMove:", colsToMove,", target:", targetPos);
		delta = 0;
						...
						if(srcItem){
							...
							try{
								...
								++obj.idx;
								 ...
								 0 && console.log("insertRows newItem:",e,item);
							}
						}else{
