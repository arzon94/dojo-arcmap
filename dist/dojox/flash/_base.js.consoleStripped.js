...
dojox.flash = {
	...
	_initialize: function(){
		// 0 && console.debug("dojox.flash._initialize");
...
dojox.flash.Embed.prototype = {
	...
	setVisible: function(/* Boolean */ visible){
		...
		// 0 && console.debug("setVisible, visible="+visible);
...
dojox.flash.Communicator.prototype = {
	...
	_addExternalInterfaceCallback: function(methodName){
		// 0 && console.debug("addExternalInterfaceCallback, methodName="+methodName);
	...
	_encodeData: function(data){
		// 0 && console.debug("encodeData, data=", data);
	...
	_decodeData: function(data){
		// 0 && console.debug("decodeData, data=", data);
	...
	_execFlash: function(methodName, methodArgs){
		// 0 && console.debug("execFlash, methodName="+methodName+", methodArgs=", methodArgs);
