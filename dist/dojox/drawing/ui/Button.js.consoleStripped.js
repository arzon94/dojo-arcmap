...
var Button = oo.declare(
	function(options){
		...
		if(options.icon && !options.icon.text){
			...
			// 0 && console.log("  button:", this.toolType, this.style.button.icon)
