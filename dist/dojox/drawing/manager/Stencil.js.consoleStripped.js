		...
		},
		{
			...
			register: function(/*Object*/stencil){
				...
				//		or drag ability.
				 ...
				 0 && console.log("Selection.register ::::::", stencil.id);
			...
			unregister: function(/*Object*/stencil){
				...
				//		the list.
				 ...
				 0 && console.log("Selection.unregister ::::::", stencil.id, "sel:", stencil.selected);
				if(stencil){
			...
			unDelete: function(/*Array*/stencils){
				...
				//		Undeletes a stencil. Used in undo stack.
				 ...
				 0 && console.log("unDelete:", stencils);
			...
			onDelete: function(/*Boolean*/noundo){
				...
				//		Event fired on deletion of a stencil
				 ...
				 0 && console.log("Stencil onDelete", noundo);
				if(noundo!==true){
					this.undo.add({
			...
			onDeselect: function(stencil, keepObject){
				...
				// 0 && console.log('onDeselect, keep:', keepObject, "stencil:", stencil.type)
			...
			onSelect: function(/*Object*/stencil){
				...
				// 0 && console.log("stencil.onSelect", stencil);
				if(!stencil){
			...
			onLabelDoubleClick: function(/*EventObject*/obj){
				...
				//		for label edits
				 0 && console.info("mgr.onLabelDoubleClick:", obj);
			...
			onStencilDoubleClick: function(/*EventObject*/obj){
				...
				//		Event fired on the double-click of a stencil
				 ...
				 0 && console.info("mgr.onStencilDoubleClick:", obj);
				if(this.selectedStencils[obj.id]){
					if(this.selectedStencils[obj.id].edit){
						 0 && console.info("Mgr Stencil Edit -> ", this.selectedStencils[obj.id]);
			...
			onStencilDown: function(/*EventObject*/obj, evt){
				...
				//		Event fired on mousedown on a stencil
				 ...
				 0 && console.info(" >>> onStencilDown:", obj.id, this.keys.meta);
				...
				if(this.selectedStencils[obj.id] && this.keys.meta){
					...
					return;
					 ...
					 0 && console.log("    clicked on selected");
					...
					return;
					 ...
					 0 && console.log("    deselect all");
					this.deselect();
				
				}else{
					// meta-key add
					// 0 && console.log("reset sel and add stencil")
				}
				 0 && console.log("    add stencil to selection");
				// add a stencil
			...
			onLabelDown: function(/*EventObject*/obj, evt){
				...
				// 0 && console.info("===============>>>Label click: ",obj, " evt: ",evt);
