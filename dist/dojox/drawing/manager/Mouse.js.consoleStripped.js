...
return oo.declare(
	...
	
	{
		...
		_broadcastEvent:function(strEvt, obj){
			...
			// 0 && console.log("mouse.broadcast:", strEvt, obj)
		...
		onDown: function(obj){
			...
			// 0 && console.info("onDown:", this.eventName("down"))
		...
		onUp: function(obj){
			...
			if(nm == "onStencilUp"){
			 ...
			 0 && console.info("Up Event:", this.id, nm, "id:", obj.id);
			this._broadcastEvent(nm, obj);
		...
		down: function(evt){
			...
			// 0 && console.log("DOWN:", this.id, id, withinCanvas);
			// 0 && console.log("this.drawingType:", this.drawingType);
		...
		move: function(evt){
			...
			if(this.id=="MUI"){
				// 0 && console.log("obj.id:", obj.id, "was:", this.currentNodeId)
			}
