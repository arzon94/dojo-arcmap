...
var Text = oo.declare(
	...
	},
	{
		...
		render: function(/* String*/text){
			...
			// 0 && console.log("text render, outline:", !this.annotation, this.renderHit, (!this.annotation && this.renderHit))
			...
			/* 0 && console.log("    render ", this.type, this.id)
			 0 && console.log("    render Y:", d.y, "textSize:", this.textSize, "LH:", this._lineHeight)
			 0 && console.log("    render text:", y, " ... ", this._text, "enabled:", this.enabled);
			 0 && console.log("    render text:", this.style.currentText);
			*/
