...
define(["require", "exports", "esri/Map", "esri/views/MapView", "esri/layers/FeatureLayer", "esri/widgets/Search", "esri/widgets/Home"],
function(require, exports, Map, MapView, FeatureLayer, Search, Home) {
  "use strict";
  var app = {};
  app.init = function() {
    //load the basemap
